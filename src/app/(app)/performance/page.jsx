...
export default function PerformancePage() {
  ...
  const { closed, banking, S, accountSize, flows, all } = useJournal();
  return <Performance closed={closed} banking={banking} S={S} accountSize={accountSize} flows={flows} all={all} />;
}
